<div>
    ...
    <form class="card card-md" method="post" wire:submit.prevent="resetHandler()" autocomplete="off">
        <div class="card-body">
            <h2 class="card-title text-center mb-4">Reset</h2>
            <div class="mb-3">
                <label class="form-label">Email address</label>
                {{-- <input type="email" class="form-control" wire:model="email" placeholder="Enter email"> --}}
                <input type="text" class="form-control" wire:model="email" placeholder="Email " disabled>
            ...
            <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                    <input id="showPassword" type="password" class="form-control" placeholder="New Password"
                        wire:model="new_password" autocomplete="off">
            ...
            <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                    <input id="showPassword" type="password" class="form-control" placeholder="Confirm Password"
                        wire:model="confirm_new_password" autocomplete="off">
                    <span class="input-group-text">
                        <a class="link-secondary show-password" title="Show password" data-bs-toggle="tooltip">
                            <!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
